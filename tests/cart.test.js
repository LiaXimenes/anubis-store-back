...
describe("GET /cart", () => {
    ...
    it("returns array of selected products for successful request", async () =>{
        ...
        {'id': 2, 'title': 'Coçador de Bigodes', 'price': 'R$ 5,99', 'imageUrl': 'https://ae01.alicdn.com/kf/H312524278ed2491da8311324dd2b7bbd8/Gatos-escova-de-canto-gato-massagem-auto-groomer-pente-escova-gato-esfrega-o-rosto-com-um.jpg_Q90.jpg_.webp'}]);
    });  
});
afterAll(() => {
    connection.end();
